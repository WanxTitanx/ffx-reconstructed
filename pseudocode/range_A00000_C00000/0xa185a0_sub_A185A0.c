...
int __userpurge sub_A185A0@<eax>(_DWORD *a1@<ecx>, int a2@<ebx>, int a3@<edi>, int a4, int a5)
{
  int result; // eax
  int v7; // eax
  int v8; // ecx
  ...
  a1[994] = sub_56CD50("ColorBuffer");
  a1[995] = sub_56CD50("DownsampledColorBuffer");
  a1[996] = sub_56CD50("BlurredColorBuffer");
  a1[997] = sub_56CD50("DepthBuffer");
  a1[998] = sub_56CD50("FocusBuffer");
  a1[999] = sub_56CD50("GaussianBlurWeights");
  a1[1000] = sub_56CD50("GaussianBlurOffsets");
  a1[1001] = sub_56CD50("JitterSamples");
  a1[1002] = sub_56CD50("JitterSampleDistances");
  a1[1003] = sub_56CD50("JitterSampleWeights");
