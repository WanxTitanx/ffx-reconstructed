...
int __cdecl sub_A08830(int a1)
{
  ...
  if ( !v1 )
  {
    Phyre_PObject_ComputeLayout(dword_19445A8);
    goto LABEL_11;
  }
  v2 = *v1;
  v3 = v1[1];
...
LABEL_11:
    ...
    *(_DWORD *)&byte_C96298[2056] = "Phyre::PScripting::PScriptAccessors::PObjectAccessor<class Phyre::PPostProcessing::PFXAA &>::Get";
    Lua_Error(
      a1,
