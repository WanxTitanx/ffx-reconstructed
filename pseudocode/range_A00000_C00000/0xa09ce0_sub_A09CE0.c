...
int __cdecl sub_A09CE0(int a1)
{
  ...
  if ( !v1 )
  {
    Phyre_PObject_ComputeLayout(dword_19446D8);
    goto LABEL_11;
  }
  v2 = *v1;
  v3 = v1[1];
  ...
  while ( v5 != dword_19446D8 )
  {
    ...
    if ( !v5 )
    {
      ...
      *(_DWORD *)&byte_C96298[2056] = "Phyre::PScripting::PScriptAccessors::PObjectAccessor<class Phyre::PPostProcessing:"
                                      ":PScreenSpaceReflectionBase &>::Get";
      Lua_Error(
        a1,
