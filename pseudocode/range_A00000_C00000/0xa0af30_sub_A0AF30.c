...
int __cdecl sub_A0AF30(int a1)
{
  ...
  else
  {
    if ( Lua_Type(a1, -1) )
    {
      ...
      *(_DWORD *)&byte_C96298[2056] = "Phyre::PScripting::PScriptAccessors::PObjectAccessor<class Phyre::PPostProcessing::PMLAA *>::Get";
      Lua_Error(
        a1,
