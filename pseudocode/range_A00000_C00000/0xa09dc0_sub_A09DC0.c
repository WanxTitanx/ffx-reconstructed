...
int __cdecl sub_A09DC0(int a1)
{
  ...
  if ( !v1 )
  {
    Phyre_PObject_ComputeLayout(dword_1944808);
    goto LABEL_11;
  }
  v2 = *v1;
  v3 = v1[1];
...
LABEL_11:
    ...
    *(_DWORD *)&byte_C96298[2056] = "Phyre::PScripting::PScriptAccessors::PObjectAccessor<class Phyre::PPostProcessing::P"
                                    "ScreenSpaceReflectionD3D11 &>::Get";
    Lua_Error(
      a1,
  ...
  while ( v5 != dword_1944808 )
  {
    ...
    if ( !v5 )
    {
      ...
      *(_DWORD *)&byte_C96298[2056] = "Phyre::PScripting::PScriptAccessors::PObjectAccessor<class Phyre::PPostProcessing:"
                                      ":PScreenSpaceReflectionD3D11 &>::Get";
      Lua_Error(
        a1,
