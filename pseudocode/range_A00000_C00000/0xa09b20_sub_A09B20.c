...
int __cdecl sub_A09B20(int a1)
{
  ...
  if ( !v1 )
  {
    Phyre_PObject_ComputeLayout(dword_1943D08);
    goto LABEL_11;
  }
  v2 = *v1;
  v3 = v1[1];
...
LABEL_11:
    ...
    *(_DWORD *)&byte_C96298[2056] = "Phyre::PScripting::PScriptAccessors::PObjectAccessor<class Phyre::PPostProcessing::P"
                                    "ScreenSpaceAmbientOcclusionD3D11 &>::Get";
    Lua_Error(
      a1,
  ...
  while ( v5 != dword_1943D08 )
  {
    ...
    if ( !v5 )
    {
      ...
      *(_DWORD *)&byte_C96298[2056] = "Phyre::PScripting::PScriptAccessors::PObjectAccessor<class Phyre::PPostProcessing:"
                                      ":PScreenSpaceAmbientOcclusionD3D11 &>::Get";
      Lua_Error(
        a1,
