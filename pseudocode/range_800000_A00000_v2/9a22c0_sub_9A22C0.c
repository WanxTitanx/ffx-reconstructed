// Function: sub_9A22C0
// Address: 0x9a22c0
int __userpurge sub_9A22C0@<eax>(int a1@<ebp>, int a2, const void *src, int *a4)
{
  int n64_3; // eax
  _DWORD *n64_8; // edi
  int n64; // ecx
  ...
  char v24; // [esp+20h] [ebp-50h]
  __m128 v25; // [esp+24h] [ebp-4Ch]
  _DWORD *n64_14; // [esp+40h] [ebp-30h]
  _DWORD *n64_2; // [esp+44h] [ebp-2Ch]
  _DWORD *n64_5; // [esp+48h] [ebp-28h]
  __m128 *v29; // [esp+4Ch] [ebp-24h]
  _DWORD *n64_9; // [esp+50h] [ebp-20h]
  int *v31; // [esp+54h] [ebp-1Ch]
  _DWORD n64_12[2]; // [esp+58h] [ebp-18h] BYREF
  int v33; // [esp+60h] [ebp-10h]
  int v34; // [esp+64h] [ebp-Ch]
  void *v35; // [esp+68h] [ebp-8h]
  int v36; // [esp+6Ch] [ebp-4h] BYREF
  ...
  if ( a2 )
  {
    ...
    do
    {
      ...
      v25 = _mm_or_ps(_mm_cmplt_ps(dst[1], *v8), _mm_cmplt_ps(v8[1], dst[0]));
      v29 = v8;
      n64_3 = v25.m128_i32[2] | v25.m128_i32[1] | v25.m128_i32[0];
      n64_13 = n64_4;
      if ( !n64_3 )
      {
        if ( v8[2].m128_i32[2] )
        ...
        else
        {
          ...
          if ( v29 != v19 )
          {
            (*(void (__thiscall **)(_DWORD, __int32, __int32))(**(_DWORD **)(*a4 + 96) + 4))(
              *(_DWORD *)(*a4 + 96),
              v29[2].m128_i32[1],
              v19[2].m128_i32[1]);
            n64_3 = *a4;
