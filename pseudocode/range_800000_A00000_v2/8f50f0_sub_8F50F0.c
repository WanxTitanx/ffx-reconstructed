// Function: sub_8F50F0
// Address: 0x8f50f0
char __cdecl sub_8F50F0(__int16 a1, float a2, float a3, float a4)
{
  ...
  EntryWithMask = FFX_BtlEdge_TableGetEntryWithMask(a1, &v14);
  v5 = (char *)(v14 + *(unsigned __int16 *)EntryWithMask);
  v10 = EntryWithMask[18];
