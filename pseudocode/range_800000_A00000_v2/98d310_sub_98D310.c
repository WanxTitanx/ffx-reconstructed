// Function: sub_98D310
// Address: 0x98d310
int __userpurge sub_98D310@<eax>(int a1@<ecx>, int a2@<ebp>, int dst_10)
{
  int v3; // esi
  double v4; // st7
  int dst_19; // edi
  ...
  v48 = a1;
  *(float *)(a1 + 32) = v4;
  *(float *)(a1 + 36) = *(float *)(dst_10 + 20);
  *(float *)(a1 + 40) = *(float *)(dst_10 + 24);
  *(float *)(a1 + 44) = *(float *)(dst_10 + 28);
  *(float *)(a1 + 16) = *(float *)dst_10;
  *(float *)(a1 + 20) = *(float *)(dst_10 + 4);
  *(float *)(a1 + 24) = *(float *)(dst_10 + 8);
  *(float *)(a1 + 28) = *(float *)(dst_10 + 12);
  *(float *)(a1 + 48) = *(float *)(dst_10 + 32);
  *(float *)(a1 + 52) = *(float *)(dst_10 + 36);
  *(float *)(a1 + 56) = *(float *)(dst_10 + 40);
  *(float *)(a1 + 60) = *(float *)(dst_10 + 44);
  *(_DWORD *)(a1 + 68) = *(_DWORD *)(dst_10 + 48);
  *(_BYTE *)(a1 + 72) = *(_DWORD *)(dst_10 + 52) != 0;
  dst_19 = *(_DWORD *)(dst_10 + 56);
  ...
  if ( dst_19 )
  {
    ...
    if ( dst_19 > 0 )
    {
      ...
      do
      {
        v16 = *(_DWORD *)(v3 + 108);
        dst_12 = dst_7;
        *(float *)&v15[v16 + 16] = *(float *)(v14 + 16);
        v14 += 48;
        *(float *)&v15[v16 + 20] = *(float *)(v14 - 28);
        *(float *)&v15[v16 + 24] = *(float *)(v14 - 24);
        *(float *)&v15[v16 + 28] = *(float *)(v14 - 20);
  ...
  *(_DWORD *)(v3 + 140) = dst_13;
  if ( dst_13 )
  {
    ...
    if ( dst_13 > 0 )
    {
      ...
      {
        v19 = dst_7-- == (char *)1;
        *(_DWORD *)(v31 + *(_DWORD *)(v3 + 148) + 12) = *(_DWORD *)(v30 + 12);
        v31 += 16;
        *(_WORD *)(v31 + *(_DWORD *)(v3 + 148) - 10) = *(_WORD *)(v30 + 6);
        v32 = *(_WORD *)(v30 + 8);
        v30 += 16;
        *(_WORD *)(v31 + *(_DWORD *)(v3 + 148) - 8) = v32;
        *(_WORD *)(v31 + *(_DWORD *)(v3 + 148) - 6) = *(_WORD *)(v30 - 6);
        *(_WORD *)(v31 + *(_DWORD *)(v3 + 148) - 16) = *(_WORD *)(v30 - 16);
        *(_WORD *)(v31 + *(_DWORD *)(v3 + 148) - 14) = *(_WORD *)(v30 - 14);
        *(_WORD *)(v31 + *(_DWORD *)(v3 + 148) - 12) = *(_WORD *)(v30 - 12);
      }
      while ( !v19 );
    }
  }
  dst_9 = *(_DWORD *)(dst_10 + 76);
  *(_DWORD *)(v3 + 156) = dst_9;
  dst_17 = *(_DWORD *)(dst_10 + 80);
  ...
  if ( dst_17 )
  {
    ...
    if ( dst_17 > 0 )
    {
      ...
      do
      {
        v19 = dst_18-- == 1;
        v42 += 32;
        *(_WORD *)(*(_DWORD *)(v3 + 172) + v42 - 26) = *(_WORD *)(v41 + 14);
        v43 = *(_WORD *)(v41 + 16);
        v41 += 20;
        *(_WORD *)(*(_DWORD *)(v3 + 172) + v42 - 24) = v43;
        *(_WORD *)(*(_DWORD *)(v3 + 172) + v42 - 22) = *(_WORD *)(v41 - 2);
        *(_WORD *)(v42 + *(_DWORD *)(v3 + 172) - 32) = *(_WORD *)(v41 - 12);
        *(_WORD *)(*(_DWORD *)(v3 + 172) + v42 - 30) = *(_WORD *)(v41 - 10);
        *(_WORD *)(*(_DWORD *)(v3 + 172) + v42 - 28) = *(_WORD *)(v41 - 8);
        *(_DWORD *)(*(_DWORD *)(v3 + 172) + v42 - 20) = *(_DWORD *)(v41 - 20);
        dst_9 = *(_DWORD *)(v41 - 16);
        *(_DWORD *)(*(_DWORD *)(v3 + 172) + v42 - 16) = dst_9;
      }
      while ( !v19 );
    }
  }
