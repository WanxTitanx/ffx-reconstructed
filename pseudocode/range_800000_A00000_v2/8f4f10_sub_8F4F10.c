// Function: sub_8F4F10
// Address: 0x8f4f10
char __cdecl sub_8F4F10(int a1, float a2, float a3, float a4)
{
  ...
  v4 = (unsigned __int16 *)sub_7909C0(a1, &v14);
  v5 = (char *)(v14 + *v4);
  v10 = *((_BYTE *)v4 + 104);
  ...
  v7 = v12;
  *(float *)&v13 = FFX_Menu2D_ScaleX_1920to512(170.0) + a2;
  sub_8E6AF0(v13, v7, v8, v9, v10, 0x80u, 0x80u, 0x80u, 0x80u);
  v15 = FFX_Menu2D_ScaleY_1080to416(10.0) + a3;
  v11 = v15;
  v16 = FFX_Menu2D_ScaleX_1920to512(236.0) + a2;
